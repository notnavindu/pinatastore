export declare class Pinatastore {
     ...
     * @returns ipfs hash
     */
    getDoc(collection: string, document: string): Promise<any>;
    /**
     ...
     */
    add(collection: string, data: string, primaryKeys?: Array<PrimaryKey>): Promise<string>;
    /**
     ...
     */
    set(collection: string, document: string, data: any, primaryKeys?: Array<PrimaryKey>): Promise<void>;
}
